...
{{-- MAIN --}}
    ...
    <x-recommended-page class="col-span-2 lg:col-span-1 bg-[url('/public/assets/img/spa.webp')] bg-center" link="{{route('hotel-attractions.show','spa')}}" text="Poznaj nasze SPA">
        <x-heading smaller="true" subtitle="Renowacja i relaks w naszym SPA" title="Odkryj Pełnię Spokoju" 
            colorTitle="text-white" colorSubtitle='textwhite group-hover:text-fontPrimary duration-500' />
    </x-recommended-page>

    <x-recommended-page class="col-span-2 lg:col-span-1 bg-[url('/public/assets/img/pool.webp')] bg-center" link="{{route('hotel-attractions.show','basen')}}" text="Poznaj nasz basen">
