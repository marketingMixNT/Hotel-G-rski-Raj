        ...
        <div class="swiper advantages-carousel shadow-lg">
            <div class="swiper-wrapper ">
                ...
                <div class="swiper-slide min-h-[800px] max-h-[800px] lg:max-h-[600px] lg:min-h-[600px] 2xl:max-h-[800px] 2xl:min-h-[800px]  w-full relative">
                    <img src="{{'/storage/' . $advantage['thumbnail']}}" alt="" class="absolute h-full w-full object-cover object-top lg:object-center">
                    <div class=" bg-white absolute z-50 left-0  top-[50%] md:top-[60%] lg:top-[50%] 2xl:top-[60%] bottom-0  right-[30%] xl:right-[50%] max:right-[55%]   px-5 md:px-20 pt-10 flex flex-col justify-start items-start gap-6">
