    ...
    <div class="max-w-screen-xl mx-auto space-y-10">
        ...
        <div
            ...
            <div class="flex items-center justify-center col-span-4 lg:col-span-1">
                <a href="/">
                    <img src="{{ asset('/assets/logo/logo--white.png') }}" alt="logo Zajazdu Śleboda"
            ...
            <div class="mx-4  md:mx-12">
                ...
                <div class="flex justify-center sm:justify-start items-center gap-3">
                    <a href="https://www.facebook.com/marketingmixnowytarg" target="_blank"><img
                            src="{{ asset('/assets/icons/facebook--white.svg') }}" alt="facebook Zajazd Śleboda"
                            class="w-6 hover:scale-110 duration-300" /></a>
                    <a href="https://www.instagram.com/marketingmix_pl/" target="_blank"><img
                            src="{{ asset('/assets/icons/instagram--white.svg') }}" alt="TripAdvisor Zajazd Śleboda"
                            class="w-6 hover:scale-110 duration-300" /></a>
                </div>
            </div>
        ...
        <div class="max-w-screen-lg mx-4 sm:mx-24 xl:mx-auto">
            ...
            <ul class="flex justify-center items-center gap-8 text-xs py-4">
                <li>
                    <a href="{{route('privacy-policy')}}" class="link-hover">Polityka Prywatności</a>
                </li>
        ...
        <div class="max-w-screen-lg mx-4 sm:mx-24 xl:mx-auto text-sm  flex justify-between items-center">
            <a href="{{route('home')}}" class="flex gap-2 justify-start items-center link-hover">
